...
<template>
  <div class="w-full flex flex-col justify-between min-h-screen bg-cover bg-gradient-to-br from-cyan-100 to-indigo-200 ...">
  <div class="pl-12 mb-4 text-5xl font-extrabold leading-none tracking-tight text-white md:text-5xl lg:text-6xl drop-shadow-xl flex items-stretch">
    <strong
