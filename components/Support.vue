<template>
	<div id="support" data-aos="fade-up" data-aos-delay="300" class="mx-auto my-16 flex px-5 py-12 md:py-32">
			...
			<div class="pt-8 md:mr-8">
				<div class="text-center md:text-start lg:pl-16 lg:pr-10 xl:pl-28">
					<div>
						...
						<div
							class="mx-auto mt-1 h-1 w-[125px] rounded-md bg-gradient-to-r from-sky-300 via-blue-500 to-indigo-400 drop-shadow-[0_0_0.6rem_#3269eb70] md:mx-0"
						></div>
					</div>
					<div>
						...
						<div class="mb-6 mt-6 md:mb-0">
							<nuxt-link href="https://ko-fi.com/lucialv">
								...
								>
									<span
										class="relative flex items-center rounded-md bg-white px-5 py-2 font-semibold transition-all duration-75 ease-in group-hover:bg-opacity-0 dark:bg-zinc-900"
									>
										Send me a coffe!
									</span>
								</button>
